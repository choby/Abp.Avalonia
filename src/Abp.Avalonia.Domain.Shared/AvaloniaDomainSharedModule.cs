...
public class AvaloniaDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AvaloniaGlobalFeatureConfigurator.Configure();
        AvaloniaModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AvaloniaDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AvaloniaResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Avalonia");

            options.DefaultResourceType = typeof(AvaloniaResource);
        ...
        {
            options.MapCodeNamespace("Avalonia", typeof(AvaloniaResource));
        });
    }
}
